...
class Emu_Update_Core {
    ...
    public function __construct($plugin_slug, $plugin_dir, $plugin_file, $api_url = '') {
        ...
        // Adiciona hooks apenas quando necessário
        add_action('load-update-core.php', [$this, 'add_update_hooks'], 5); // Na tela de atualizações
        add_action('load-plugins.php', [$this, 'add_update_hooks'], 5); // Na lista de plugins
        add_action('upgrader_process_complete', [$this, 'add_post_update_hooks'], 5); // Após atualizações
    }

    public function add_update_hooks() {
        // Hooks específicos para verificação de atualizações
        add_filter('plugins_api', [$this, 'plugin_info'], 20, 3);
        add_filter('site_transient_update_plugins', [$this, 'check_for_update']);
    }

    public function add_post_update_hooks() {
        // Hooks específicos para pós-atualização
        add_filter('upgrader_source_selection', [$this, 'fix_plugin_directory'], 10, 4);
        add_action('upgrader_install_package_result', [$this, 'verify_installation'], 10, 2);
    ...
    public function check_for_update($transient) {
        ...
        // Cache de 12 horas para reduzir requisições
        $cache_key = 'emu_update_' . md5($this->plugin_slug);
